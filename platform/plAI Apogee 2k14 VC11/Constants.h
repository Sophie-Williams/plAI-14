...
#define DEFAULT_MAP_PATH "Maps\\Default Map 1366x768.bmp"
...
#define PLAYER2_HEADER_FILE "HumanPlayerWASD.h"
#define PLAYER2_CLASS_NAME HumanPlayerWASD

#define FISH_WIDTH 20
#define FISH_HEIGHT 20
#define FISH_PRESENSE_RADIUS 20

#define RAFT_RADIUS 20
#define RAFT_MASS 1000.0f
#define RAFT_ENGINE_FORCE 400.0f * RAFT_MASS
#define RAFT_DRAG_REGULAR 20.0f
#define RAFT_DRAG_BRAKE 50.0f
#define RAFT_COEFF_RESTITUTION 0.2f
#define RAFT_VISIBILITY_RADIUS 120
#define RAFT_MAX_HEALTH 100
#define RAFT_NUMBER_OF_COLLISION_POINTS 36


#define CANNON_BALL_SPEED 300 //pixels per second
#define CANNON_BALL_RADIUS 3 //pixels
#define CANNONBALL_DAMAGE 7
...
#define RIPPLEMAP_WIDTH 400
#define RIPPLEMAP_HEIGHT 225
