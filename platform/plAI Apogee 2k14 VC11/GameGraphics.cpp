...
{
	waterPoints1 = (WaterPoint*)malloc(RIPPLEMAP_WIDTH * RIPPLEMAP_HEIGHT * sizeof(WaterPoint));
	waterPoints2 = (WaterPoint*)malloc(RIPPLEMAP_WIDTH * RIPPLEMAP_HEIGHT * sizeof(WaterPoint));
